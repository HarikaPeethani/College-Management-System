...
<title>MICROSOFT PLACEMENTS</title>
...
<div id="article"><br />
<h3 style="text-align:center;">MICROSOFT PLACEMENTS</h3>
...
<?php 
$result=mysql_query("select * from placement where company_name='Microsoft'");
