...
<div id="article"><br />
<h3 style="text-align:center;">ALSTOM PLACEMENTS</h3>
...
<?php 
$result=mysql_query("select * from placement where company_name='Alstom Corporate'");
