...
<html>
<head>
<title>Change CSE HOD Page</title>
...
$rslt=mysql_query("select staffid from staff where (dept='CSE' and designation='HOD')");
...
if(isset($_POST['Submit'])){
	...
	if(empty($Staffid)){
		...
		$res=mysql_query("select staffid from staff where dept='CSE'");
			...
			if($flag1!=1){
				$StaffidErr="Staff does not exist in CSE dept";
				$flag=1;
				$flag3=1;
			}
		}
