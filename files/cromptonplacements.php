...
<title>CROMPTON PLACEMENTS</title>
...
<div id="article"><br />
<h3 style="text-align:center;">CROMPTON PLACEMENTS</h3>
...
<?php 
$result=mysql_query("select * from placement where company_name='Crompton Greaves'");
