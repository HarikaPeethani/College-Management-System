...
<title>HAVELLS PLACEMENTS</title>
...
<div id="article"><br />
<h3 style="text-align:center;">HAVELLS PLACEMENTS</h3>
...
<?php 
$result=mysql_query("select * from placement where company_name='Havells India Ltd'");
