...
<html>
<head>
<title>Change IT Staff Page</title>
...
if(isset($_POST['changeStaffSubmit'])){
	...
	if(empty($oldStaffid)){
		...
		$res=mysql_query("select staffid from staff where dept='IT'");
			...
			if($flag1!=1){
				$oldStaffidErr="Staff does not exist in IT dept";
				$flag=1;
				$flag3=1;
			}
		}
...
<ul class="welcome">
  <li></li>
  <li><a href="ithod.php">Welcome <?php echo $staff_name;?></a></li>
